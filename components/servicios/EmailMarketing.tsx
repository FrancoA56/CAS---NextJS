...
export default function EmailMarketing() {
  ...
  return (
    <>
      ...
      <div className="md:flex md:flex-row hidden justify-center w-screen h-[100dvh] safe-area">
        <HorizontalCarousel />
      ...
      {isIOS ? (
        <div className="flex flex-col md:hidden">
          <div className="relative justify-center items-center left-36 mt-16">
            <HorizontalCarousel />
          </div>
          <div className="flex flex-col items-start justify-center text-start mx-6 text-black">
            <h2 className="text-4xl font-bold mb-1 text-green">EMAIL </h2>
            <h2 className="text-4xl font-bold mb-2 custom-stroke-green">
              {" "}
              MARKETING
            </h2>
        ...
        <div className="flex flex-col md:hidden">
          ...
          <div className="flex flex-col items-start justify-center text-start mx-6 text-black">
            <h2 className="text-6xl font-bold mb-2 text-green">EMAIL </h2>
            <h2 className="text-6xl font-bold mb-4 custom-stroke-green">
              {" "}
              MARKETING
            </h2>
