        ...
        {isIOS ? (
          <>
            <div className="text-center">
              ...
              <p className="text-sm  text-black max-w-2xl mx-auto mt-2 mb-2 ">
            ...
            <div className="flex justify-center items-center flex-col px-4">
              <form
                className="w-full max-w-2xl space-y-1 3xl:space-y-4 bg-white px-8 py-2 rounded-xl backdrop-blur-md border-2 border-gray text-black"
              ...
              >
                ...
                >
                  <p className="text-sm">
                    {file ? (
                      ...
                      <>
                        Arrastrá tu CV aquí o hacé click para seleccionar un
                        archivo (PDF o Word)
                      </>
                    )}
                  </p>
                ...
                <div className="flex justify-center items-start">
                  <button
                    type="submit"
                    className="flex flex-col items-center text-black mt-2"
                  >
          ...
          <>
            <div className="text-center">
              <div className="flex flex-col justify-center items-center">
                <p className="font-bold text-5xl 3xl:text-7xl">SUMATE</p>
                <p className="text-gradient-cas text-6xl 3xl:text-8xl">
                  AL TEAM
                </p>
              </div>
              <p className="text-base md:text-lg text-black max-w-2xl mx-auto mt-2 mb-2 3xl:mb-8">
                Si la creatividad y el trabajo en equipo es lo tuyo, compartí tu
                CV y sumate a nuestro banco de talentos para futuras
                oportunidades.{" "}
              </p>
