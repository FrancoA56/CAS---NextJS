...
export default function Clientes({ prop }) {
  ...
  return (
    <>
      {isIOS ? (
        <div className="h-[100dvh] safe-area w-full flex justify-center items-center flex-col">
          <div className="flex flex-col justify-center items-center mt-12 mb-0 md:mb-2 3xl:mb-12 ">
            <p className="font-bold text-4xl ">NUESTROS</p>
            <p className="text-gradient-cas text-4xl ">
              CLIENTES
            </p>
          </div>
          <div className="grid  grid-cols-2 w-full px-6 justify-center items-center gap-2 ">
            <div className="flex justify-center items-center flip-container w-40 h-40 ">
              ...
              <div className="flipper rotate-on-hover transition-transform duration-700">
                ...
                <div className="back-logo">
                  <p className="text-lg text-center">
                    Representante y distribuidor mayorista de productos de
                    cocina y bazar
                  </p>
                </div>
              </div>
